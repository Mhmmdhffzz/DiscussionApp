        ...
        <div className="thread-detail__footer mt-4 flex items-center">
          <div className="thread-detail__upvotes-thread mr-4">
            <button
              ...
              className={`focus:outline-none flex items-center ${isUpVoted ? 'text-blue-500' : 'text-gray-500'}`}
            >
              {isUpVoted ? <AiFillLike className="w-6 h-6 mr-1" /> : <AiFillLike className="w-6 h-6 mr-1" />}
              {upVotesBy.length}
            </button>
          </div>
          <div className="thread-detail__downvotes-thread">
            <button
              ...
              className={`focus:outline-none flex items-center ${isDownVoted ? 'text-red-500' : 'text-gray-500'}`}
            >
              {isDownVoted ? <AiFillDislike className="w-6 h-6 mr-1" /> : <AiFillDislike className="w-6 h-6 mr-1" />}
              {downVotesBy.length}
            </button>
          </div>
        </div>
